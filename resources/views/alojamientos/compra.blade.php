@extends('layouts.app')
@section('content')
	<?php $habitacion = App\Habitacion::where('id',$id)->first();?>
                                ...
                                <div class="single-destinations">            
                                    <div class="details" style="background-color: #f6fd8c ; color: black;">
                                        <ul class="package-list">
                                            ...
                                            <li class="d-flex justify-content-between align-items-center">
                                                <span> Precio </span>
                                                <span> {{$habitacion->precio*$dias}}</span>        
                                            </li>                                         
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="row justify-content-center">
                                    <div class="card">
                                        ...
                                        <form method="GET" action="/compra-habitacion-realizada/{{$id}}/{{$habitacion->precio*$dias}}">
