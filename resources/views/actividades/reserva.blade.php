@extends('layouts.app')
@section('content')
<?php $actividad = \App\Actividad::find($id);
                                ...
                                <div class="single-destinations">            
                                    <div class="details" style="background-color: #f6fd8c ; color: black;">
                                        <ul class="package-list">
                                            ...
                                            <li class="d-flex justify-content-between align-items-center">
                                                    <span>Precio </span>
                                                    <span> {{$actividad->precio*request()->personas}}      </span>
                                            </li>                                   
										</ul>
										<form>
										<input type="submit" class="primary-btn text-uppercase" value="Agregar A Carrito"
									formaction="/actividad-carro/{{$id}}/{{request()->personas}}">    
										</form>
								</div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="row justify-content-center">
                                    <div class="card">
                                        ...
                                        <form method="get" action="/compra-hecha/{{$id}}/{{request()->personas}}">
