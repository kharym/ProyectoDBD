                    ...
                    <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
                        ...
                        <div class="row justify-content-center">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-wrap" method="GET" action="/Vuelo/modificar-fechas/{{$id}}/realizar">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">    
                                                ...
                                                <input type="text" class="form-control time-picker" name="horaIda" data-time-format="HH:MM:SS" placeholder="" onfocus="this.placeholder = ''" onblur="this.placeholder = ' '" required>
                                            </div>
                                            <div class="form-group col-md-6">    
                                                <label for="Hora Vuelta" > Hora Vuelta</label>
                                                <input type="text" class="form-control time-picker" name="horaVuelta" data-time-format="HH:MM:SS" placeholder=" " onfocus="this.placeholder = ''" onblur="this.placeholder = ''" required>
                                            </div>
                                        </div>
                                        <div class="col text-center">
                                        <button type="input" class="btn btn-primary">Confirmar</button>
                                        </div>
                                    </form>
                                    <br>
                                </div>
