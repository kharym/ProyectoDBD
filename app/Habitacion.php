...
class Habitacion extends Model
{
    ...
    protected $fillable = ['reserva_habitacion_id','alojamiento_id','numero_habitacion','tipo_habitacion','numero_camas','numero_banos','disponibilidad','capacidad_ninos','capacidad_adultos'];
}